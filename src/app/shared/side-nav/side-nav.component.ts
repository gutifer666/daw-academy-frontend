...
export class SideNavComponent implements OnInit {
  ...
  moduleLessons: { [key: string]: any[] } = {
    ...
    'lenguajes-de-marcas': [
      { path: '/lenguajes-de-marcas/ut1', title: 'UT01.- Aspectos básicos de los lenguajes de marcas y sistemas de gestión empresarial' },
    ...
    'entornos-de-desarrollo': [
      ...
      { path: '/entornos-de-desarrollo/ut5', title: 'UT05.- Diseño orientado a objetos. Diagramas estructurales y de comportamiento' },
    ],
    'formacion-y-orientacion-laboral': [
      ...
      { path: '/formacion-y-orientacion-laboral/ut7', title: 'UT07.- Los equipos de trabajo y la gestión del conflicto' },
      { path: '/formacion-y-orientacion-laboral/ut8', title: 'UT08.- Búsqueda de empleo' },
    ],
    'desarrollo-web-en-entorno-cliente': [
      { path: '/desarrollo-web-en-entorno-cliente/ut1', title: 'UT01.- Arquitecturas y lenguajes de programación en clientes web - JavaScript' },
      { path: '/desarrollo-web-en-entorno-cliente/ut2', title: 'UT02.- Modelo de objetos predefinidos en JavaScript' },
      { path: '/desarrollo-web-en-entorno-cliente/ut3', title: 'UT03.- Estructuras definidas por el usuario en JavaScript' },
      { path: '/desarrollo-web-en-entorno-cliente/ut4', title: 'UT04.- Gestión de eventos y formularios en JavaScript' },
    ...
    'desarrollo-web-en-entorno-servidor': [
      { path: '/desarrollo-web-en-entorno-servidor/ut1', title: 'UT01.- Plataformas de programación web en entorno_ ervidor. Características del lenguaje_PHP' },
    ...
    'despliegue-de-aplicaciones': [
      { path: '/despliegue-de-aplicaciones/ut1', title: 'UT01.- Implantación, configuración y administración de servidores web' },
      { path: '/despliegue-de-aplicaciones/ut2', title: 'UT02.- Configuración y administración de servidores de aplicaciones' },
      { path: '/despliegue-de-aplicaciones/ut3', title: 'UT03.- Instalación y administración de servidores de alta disponibilidad.' },
      { path: '/despliegue-de-aplicaciones/ut4', title: 'UT04.- Servicios de red implicados en el despliegue de una aplicación web' },
    ...
    'diseno-de-interfaces-web': [
      ...
      { path: '/diseno-de-interfaces-web/ut2', title: 'UT02.- Guías de estilo. Prototipos. Revisión lenguaje de marcas' },
    ...
    'empresa-e-iniciativa-emprendedora': [
      ...
      { path: '/empresa-e-iniciativa-emprendedora/ut2', title: 'UT02.- Guías de estilo. Prototipos. Revisión lenguaje de marcas' },
